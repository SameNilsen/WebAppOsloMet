            ...
            if (!context.Posts.Any())
            {
                var posts = new List<Post>
                {
                    new Post
                    {
                        ...
                        UserId = 1,
                        PostDate = new DateTime(2023, 10, 3, 13, 42, 0).ToString(),
                        SubForum = "Gaming"
                    },
                    new Post
                    {
                        ...
                        UserId = 2,
                        PostDate = new DateTime(2023, 10, 5, 11, 22, 0).ToString(),
                        SubForum = "General"
                    },
                    new Post
                    {
                        ...
                        UserId = 3,
                        PostDate = new DateTime(2023, 10, 6, 17, 30, 0).ToString(),
                        SubForum = "Gaming"
                    },
                    new Post
                    {
                        ...
                        UserId = 4,
                        PostDate = new DateTime(2023, 10, 8, 19, 7, 0).ToString(),
                        SubForum = "General"
                    },
                    new Post
                    {
                        ...
                        UserId = 1,
                        PostDate = new DateTime(2023, 10, 10, 16, 10, 0).ToString(),
                        SubForum = "Politics"
                    },
                    new Post
                    {
                        ...
                        UserId = 5,
                        PostDate = new DateTime(2023, 10, 11, 9, 58, 0).ToString(),
                        SubForum = "Nature"
                    },
                    new Post
                    {
                        ...
                        UserId = 3,
                        PostDate = new DateTime(2023, 10, 14, 13, 48, 0).ToString(),
                        SubForum = "Gaming"
                    },
                    new Post
                    {
                        ...
                        UserId = 1,
                        PostDate = new DateTime(2023, 10, 15, 11, 29, 0).ToString(),
                        SubForum = "Politics"
                    },
                    new Post
                    {
                        ...
                        UserId = 6,
                        PostDate = new DateTime(2023, 10, 15, 15, 52, 0).ToString(),
                        SubForum = "General"
                    },
                    new Post
                    {
                        ...
                        UserId = 2,
                        PostDate = new DateTime(2023, 10, 19, 12, 18, 0).ToString(),
                        SubForum = "Sport"
                    },
                    new Post
                    {
                        ...
                        UserId = 4,
                        PostDate = new DateTime(2023, 10, 20, 23, 59, 0).ToString(),
                        SubForum = "School"
                    },
                    new Post
                    {
                        ...
                        UserId = 3,
                        PostDate = new DateTime(2023, 10, 22, 22, 21, 0).ToString(),
                        SubForum = "Nature"
                    },
                    new Post
                    {
                        ...
                        UserId = 6,
                        PostDate = new DateTime(2023, 10, 27, 10, 1, 0).ToString(),
                        SubForum = "General"
                    },
                    new Post
                    {
                        ...
                        UserId = 1,
                        PostDate = new DateTime(2023, 10, 28, 15, 6, 0).ToString(),
                        SubForum = "School"
                    },
                };
            ...
            if (!context.Comments.Any())
            {
                var comments = new List<Comment>
                {
                    new Comment
                    {
                        ...
                        UserId = 2,
                        PostID = 1,
                        PostDate = new DateTime(2023, 10, 3, 13, 55, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 1,
                        PostID = 2,
                        PostDate = new DateTime(2023, 10, 5, 11, 51, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 6,
                        PostID = 2,
                        PostDate = new DateTime(2023, 10, 6, 14, 19, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 1,
                        PostID = 3,
                        PostDate = new DateTime(2023, 10, 6, 17, 31, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 3,
                        PostID = 3,
                        PostDate = new DateTime(2023, 10, 6, 18, 12, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 1,
                        PostID = 4,
                        PostDate = new DateTime(2023, 10, 9, 15, 13, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 5,
                        PostID = 5,
                        PostDate = new DateTime(2023, 10, 10, 18, 6, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 3,
                        PostID = 6,
                        PostDate = new DateTime(2023, 10, 13, 8, 2, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 2,
                        PostID = 7,
                        PostDate = new DateTime(2023, 10, 14, 15, 22, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 6,
                        PostID = 7,
                        PostDate = new DateTime(2023, 10, 14, 19, 37, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 5,
                        PostID = 8,
                        PostDate = new DateTime(2023, 10, 15, 11, 30, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 5,
                        PostID = 9,
                        PostDate = new DateTime(2023, 10, 15, 15, 59, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 3,
                        PostID = 10,
                        PostDate = new DateTime(2023, 10, 20, 7, 14, 0).ToString()
                    },
                    new Comment
                    {
                        CommentText = "Really?",
                        UserId = 1,
                        PostID = 11,
                        PostDate = new DateTime(2023, 10, 21, 22, 55, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 6,
                        PostID = 11,
                        PostDate = new DateTime(2023, 10, 21, 23, 13, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 4,
                        PostID = 12,
                        PostDate = new DateTime(2023, 10, 23, 5, 49, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 2,
                        PostID = 13,
                        PostDate = new DateTime(2023, 10, 27, 12, 10, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 4,
                        PostID = 13,
                        PostDate = new DateTime(2023, 10, 27, 21, 44, 0).ToString()
                    },
                    new Comment
                    {
                        ...
                        UserId = 5,
                        PostID = 14,
                        PostDate = new DateTime(2023, 10, 28, 16, 29, 0).ToString()
                    },
                };
